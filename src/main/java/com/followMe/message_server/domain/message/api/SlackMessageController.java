...
public class SlackMessageController {
  ...
  public ResponseEntity<ApiResponse<SlackMessageDetailResponse>> update(
      @PathVariable UUID slackMessageId, @Valid @RequestBody SlackMessageUpdateRequest request) {
  ...
  public ResponseEntity<ApiResponse<Void>> delete(
      @PathVariable UUID slackMessageId, @RequestParam(required = false) UUID requestedBy) {
