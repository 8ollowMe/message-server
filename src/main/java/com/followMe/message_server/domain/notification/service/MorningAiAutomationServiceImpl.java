...
public class MorningAiAutomationServiceImpl implements MorningAiAutomationService {
  ...
  @Override
  public void execute() {
    List<DeliveryTargetDto> targets = deliveryClient.getMorningTargets("true", "MESSAGE-SERVER");
  ...
  private void processTarget(DeliveryTargetDto target) {
    ...
    try {
      DispatchDeadlineRequest aiRequest =
          DispatchDeadlineRequest.builder()
  ...
  private String buildMessage(DeliveryTargetDto target, DispatchDeadlineResponse res) {
